        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title"> {{$publication->index}} - {{$publication->name}} Üýtget </h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="{{route('publication.show', $publication->id)}}" class="kt-subheader__breadcrumbs-link">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid">
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
                                ...
                                <form class="kt-form" id="kt_user_add_form" action="{{route('publication.update', $publication->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <!--begin: Form Wizard Step 1-->
                                    <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                        <div class="kt-heading kt-heading--md">{{$publication->index}} - {{$publication->name}} maglumatlary:</div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="kt-section__body">
                                                            <div class="form-group row">
                                                                <label class="col-xl-3 col-lg-3 col-form-label">Öňki suraty</label>
                                                                <div class="col-lg-9 col-xl-9">
                                                                    @if($publication->image)
                                                                        <img src="{{asset($publication->image)}}" style="height: 150px; width: auto;" alt="">
                                                                    @else
                                                                        <label class="col-form-label">Surat ýok</label>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control @error('index') is-invalid @enderror" type="number" min="0" name="index" id="index" value="{{$publication->index}}" placeholder="Neşiriň indeksi" required>
                                                                </div>
                                                                @error('index')
                                                                <div class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{$publication->name}}" placeholder="Neşiriň ady" required>
                                                                </div>
                                                                @error('name')
                                                                <div class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9 col-xl-9">
                                                                    <div class="typeahead">
                                                                        <input dir="ltr" class="form-control @error('owner') is-invalid @enderror" type="text" name="owner" id="owner" value="{{$publication->owner}}" placeholder="Neşiriň esaslandyryjysy" required>
                                                                    </div>
                                                                </div>
                                                                @error('owner')
                                                                <div class="invalid-feedback" role="alert">
